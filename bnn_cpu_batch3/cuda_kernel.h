...
int layer3_step_cuda(float * layer1, unsigned long long * layer2);

int layer4_conv_cuda(unsigned long long * layer1, signed short * layer2);

int layer5_maxpool_cuda(signed short * layer1, signed short * layer2);

int layer8_gemm_cuda(unsigned long long * layer1, signed short * layer2);

int layer10_gemm_cuda(unsigned long long * layer1, signed short * layer2);
