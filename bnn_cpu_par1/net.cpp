...
float predict_NeuralNet(unsigned char * const x, float * pred) {
  ...
  */
  ...
  // // checksum for layer 3 gives different sums for each batch, but in the next layers it gives correct answers
  // float sum = 0;
  // ofstream g("layer_3_par1.out");
  // for(int b=0;b<BATCH_SIZE;b++){
  //     sum=0;
  //     for(int i=b*12544;i<(b+1)*12544;i++){
  //         sum += cuda_layer_3_output[i];
  ...
  */
  ...
  //     for(int b=0;b<BATCH_SIZE;b++){
  //       for(int k=0;k<64;k++){
  //         cuda_layer_7_output[index4D(b,i,j,k,14,14,64)] = layer_6_output[b][i][j][k];
  //       }
  //     }
  //   }
  // }
  ...
  // float sum = 0;
  // ofstream g("layer_6_par1.out");
  // for(int b=0;b<BATCH_SIZE;b++){
  //     sum=0;
  //     for(int i=b*3136;i<(b+1)*3136;i++){
  //         sum += cuda_layer_6_output[i];
  //         g<<cuda_layer_6_output[i]<<" ";  
  //     }
  //     g<<"\n";
  //     cout<<fixed<<"batch "<<b<<": "<<sum<<endl;
  // }
  ...
  // kernel_time += layer8_gemm(cuda_layer_7_output, cuda_layer_8_output);
  ...
  */
  ...
  //   cout<<b<<": ";
  //   for (int i = 0; i < 10; i++) {
  //     pred[b*10 + i] += cuda_layer_10_output[b*10 + i];
  //     cout<<pred[b*10 + i]<<" ";
  //   }
  //   cout<<endl;
  // }
